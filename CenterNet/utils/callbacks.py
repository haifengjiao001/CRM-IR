...
from .utils import cvtColor, preprocess_input, resize_image, resize_raw
    ...
    def on_epoch_end(self, epoch, model_eval):
        if epoch % self.period == 0 and self.eval_flag:
            ...
            for annotation_line in tqdm(self.val_lines):
                ...
                #   获得预测txt
                #------------------------------#
                self.get_map_txt(image_id, image, raw, self.class_names, self.map_out_path)
