...
if __name__ == "__main__":
    ...
    # model_path      = '/root/autodl-fs/jhf/OD/logs/YOLOV3/1/ep360-loss0.031-val_loss0.096.pth'
    # model_path      = '/root/autodl-fs/jhf/OD/logs/YOLOV3/enhance-rgb/1/ep236-loss0.044-val_loss0.093.pth'
    #------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    # save_dir            = '../../logs/YOLOV3/compress/3'
    # save_dir            = '../../logs/YOLOV3/noMGE/1'
    # save_dir            = '../../logs/YOLOV3/compress/4' 5e-6
    # save_dir            = '../../logs/YOLOV3/compress/5'##5e-7
    # save_dir            = '../../logs/YOLOV3/compress-ablation/nolocal/1'##5e-5
    save_dir            = '../../logs/YOLOV3/compress-ablation/noglobal/1'##5e-5
    #------------------------------------------------------------------#
